<template>
    <div style="position:relative">
        ...
        <div class="combobox__data" v-show="isShowData" @mouseleave="leaveInput">
            ...
            @click="selectData( data[keyCombobox],data[DataComboboxCode], data[DataComboboxName])"
...
export default {
    ...
    props: ["id", "api", "text", "keyCombobox", "DataCombobox", "DataComboboxCode", "DataComboboxName", "ModelInput"],
    ...
    methods: {
         ...
         * @param {} selectData 
         */
        selectData(id, selectData, auto) {
            // this.$refs.inputData.value = selectData;
            this.dataComboboxCode = selectData;
            this.$emit('autoComplete', id, selectData, auto);
